...
class PostBackendController extends yupe\components\controllers\BackController
{
    public function accessRules()
    {
        return [
            ['allow', 'roles' => ['admin']],
            ['allow', 'actions' => ['index'], 'roles' => ['Project.PostBackend.Index']],
            ['allow', 'actions' => ['view'], 'roles' => ['Project.PostBackend.View']],
            ['allow', 'actions' => ['create'], 'roles' => ['Project.PostBackend.Create']],
            ['allow', 'actions' => ['update', 'inline'], 'roles' => ['Project.PostBackend.Update']],
            ['allow', 'actions' => ['delete', 'multiaction'], 'roles' => ['Project.PostBackend.Delete']],
            ['deny']
        ];
    }
        ...
        if (Yii::app()->getRequest()->getIsPostRequest() && Yii::app()->getRequest()->getPost('Post')) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash(
                    ...
                    Yii::t('ProjectModule.project', 'Post was created!')
                );
                $this->redirect(
    ...
    public function actionUpdate($id)
    {
        ...
        if (Yii::app()->getRequest()->getIsPostRequest() && Yii::app()->getRequest()->getPost('Post')) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash(
                    yupe\widgets\YFlashMessages::SUCCESS_MESSAGE,
                    Yii::t('ProjectModule.project', 'Post was updated!')
                );
    ...
    public function actionDelete($id)
    {
        if (Yii::app()->getRequest()->getIsPostRequest()) {
            ...
            Yii::app()->user->setFlash(
                yupe\widgets\YFlashMessages::SUCCESS_MESSAGE,
                Yii::t('ProjectModule.project', 'Post was removed!')
            );
